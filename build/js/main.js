  ...
  */
  ...
  class Tooltip extends BaseComponent {
    ...
    _createTipElement(content) {
      const tip = this._getTemplateFactory(content).toHtml(); // TODO: remove this check in v6
  ...
  class ScrollSpy extends BaseComponent {
    ...
    _initializeTargetsAndObservables() {
      ...
      for (const anchor of targetLinks) {
        ...
        const observableSection = SelectorEngine.findOne(decodeURI(anchor.hash), this._element); // ensure that the observableSection exists & is visible
  ...
  class Tab extends BaseComponent {
    constructor(element) {
      ...
      if (!this._parent) {
        return; // TODO: should throw exception in v6
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var swiperWinners = new Swiper(".contest-winners-swiper", {
      spaceBetween: 24,
      slidesPerView: 1.5,
      navigation: {
    ...
    var swiperEbooks = new Swiper(".ebooks-swiper", {
      spaceBetween: 12,
      slidesPerView: 1.5,
      navigation: {
    ...
    var swiperShortStories = new Swiper(".short-stories-swiper", {
      spaceBetween: 24,
      slidesPerView: 1.5,
      navigation: {
    ...
    var swiperPoems = new Swiper(".poems-swiper", {
      spaceBetween: 24,
      slidesPerView: 1.5,
      navigation: {
    ...
    var swiperLimited = new Swiper(".limited-swiper", {
      spaceBetween: 12,
      slidesPerView: 1,
      navigation: {
    ...
    var swiperBoosted = new Swiper(".boosted-swiper", {
      spaceBetween: 24,
      slidesPerView: 1,
      navigation: {
    ...
    var swiperFeaturedAudio = new Swiper(".featured-audio-swiper", {
      spaceBetween: 24,
      slidesPerView: 1.5,
      navigation: {
    ...
    var newPostingsBooks = new Swiper(".new-postings-swiper", {
      spaceBetween: 12,
      slidesPerView: 1.5,
      navigation: {
    ...
    var newMembersBooks = new Swiper(".new-members-swiper", {
      spaceBetween: 12,
      slidesPerView: 1.5,
      navigation: {
    ...
    var bookShortStories = new Swiper(".book-short-stories-swiper", {
      spaceBetween: 12,
      slidesPerView: 1.5,
      navigation: {
    ...
    var otherBooks = new Swiper(".boosted-other-swiper", {
      spaceBetween: 12,
      slidesPerView: 1.5,
      navigation: {
    ...
    var homeProfileBoosterSwiper = new Swiper(".home-profile-booster-swiper", {
      spaceBetween: 12,
      slidesPerView: 2,
      breakpoints: {
        768: {
    ...
    var promotedBooksSwiper = new Swiper(".promoted-books-swiper", {
      spaceBetween: 12,
      slidesPerView: 2,
      breakpoints: {
        576: {
